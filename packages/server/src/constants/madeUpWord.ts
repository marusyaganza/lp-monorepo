...
export const madeUphWords = {
  [Language.English]: [
    ...
    },
    {
      name: 'serenova',
      shortDef: [
        'comforting, melodious sound of raindrops gently tapping against your window as you find solace in its rhythmic cadence'
      ]
    }
  ],
  [Language.Spanish]: [
    ...
    },
    {
      name: 'aventuraíz',
      shortDef: [
        'the feeling of wanderlust and longing for adventure that takes root deep within, inspiring dreams of far-off places'
      ]
    }
  ]
};
