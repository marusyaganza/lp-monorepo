...
export const WordCard = memo(
  ({ word }: WordCardProps) => {
    ...
    const renderAudio = (transcription: string | undefined, audioUrl: string | undefined) => {
    ...
    return (
        <article className="word">
         ...
         {imgUrl && <img className="image" src={imgUrl} alt={`${name} picture.`} width={150} height={150} />}
        </article>
    );
  }
);
